...
class ShittyProfilerServiceProvider extends ServiceProvider {
	...
	{
		AliasLoader::getInstance()->alias('Profiler', 'Pitekantrop\ShittyProfiler\ShittyProfiler');
		...
		if ($this->profilerEnabled()) 
		{
			...
			{
				$prof = new ShittyProfiler(microtime(true), $app);
